...
class UserController extends GxController {
    ...
    public function actionSignup() {
        ...
        if (isset($_GET ['test'])) {
            ...
            $_POST ['User'] ['email'] = 'admin11@gmail.com';
...
//        );
//        if (isset($_GET['test'])) {
//            $_POST ['User'] ['email'] = 'himekaranguleria@gmail.com';
//        }
//        $id = Yii::app()->user->id;
...
//                $pass[] = $alphabet[$n];
//            }
//            $_POST ['User'] ['password'] = implode($pass);
...
//    }
    ...
    public function actionLogin() {
        ...
        if (isset($_GET ['test'])) {
            $_POST ['LoginForm'] ['username'] = 'email@gmail.com';
            $_POST ['LoginForm'] ['password'] = 'admin@123';
