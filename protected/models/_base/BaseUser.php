...
abstract class BaseUser extends GxActiveRecord
    ...
    public static function label($n = 1)
        {
        return Yii::t('app', 'Nutzerübersicht|Nutzerübersicht', $n);
        }
    ...
    public function rules()
        {
        return array(
            // array('first_name, last_name, email, password, language, date_of_birth, salary, martial_status, employment, address, city, country, zip_code, currency_type, timezone, lat, long, role_id', 'required'),
            array(
                'first_name,email',
                'required'
            ),
            array(
                'salary, martial_status, zip_code, currency_type, tos, role_id, state_id, login_error_count, employer_id, create_user_id,phone_no',
                'numerical',
                'integerOnly' => true
            ),
//            array(
...
//            ),
            array(
                'first_name, last_name, language,username, employment, address, city, country, lat, long,company_name,company_profile,mobile_no',
                'length',
                'max' => 256
            ),
            array(
            ...
            array(
                'about_me, last_visit_time, create_time,is_notification,date_of_birth,mobile_no,company_name,company_profile',
                'safe'
            ),
            array(
                'phone_no, about_me, tos, state_id, last_visit_time, activation_key, login_error_count, employer_id, create_user_id, create_time',
                'default',
                'setOnEmpty' => true,
                'value' => null
            ),
            array(
                'id,mobile_no,company_name,company_profile, first_name, last_name, email, password, phone_no, language, date_of_birth, salary, martial_status, employment, address, city, country, zip_code, currency_type, timezone, about_me, image_file, lat, long, tos, role_id, state_id, last_visit_time, activation_key, login_error_count, employer_id, create_user_id, create_time,username',
                'safe',
                'on' => 'search'
            )
        );
    ...
    public function attributeLabels()
        ...
        return array(
            ...
            'create_time' => Yii::t('app', 'Registriert seit'),
            'authSessions' => null,
            'blogs' => null,
            'comments' => null,
            'favourites' => null,
    ...
    public function search()
        ...
        $criteria->compare('role_id', User::ROLE_EMPLOYER);
