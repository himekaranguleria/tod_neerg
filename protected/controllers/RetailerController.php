...
class RetailerController extends GxController {
	...
	public function actionCreate() 
	{
		...
		$this->performAjaxValidation($model, 'retailer-form');

		if (isset($_POST['Retailer'])) {
			$model->setAttributes($_POST['Retailer']);
     $model->address=$model->street." ".$model->city." ".$model->zip_code;
	...
	public function actionDelete($id) 
	{
		...
		if (Yii::app()->getRequest()->getIsPostRequest()) {
			$this->loadModel($id, 'Retailer')->delete();
	...
	public function actionSearch()
	{
		...
		{
			$model->setAttributes($_GET['Retailer']);
	...
	{	
		...
		if ( $model == null ) $model = new Retailer();
