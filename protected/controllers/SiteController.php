...
//        $this->updateMenuItems($model);
    ...
    public function actionAbout()
        {
        $this->pageCaption = "About - Green Dot";
        $this->layout = '//layouts/column1';
        $this->render('about');
        }
    ...
    public function actionMenu()
        {
        $this->pageCaption = "Menu - Green Dot";
        $this->layout = '//layouts/column1';
        $this->render('menu');
        }
    ...
    public function actionEvents()
        {
        $this->pageCaption = 'Events - Green Dot';
        $this->layout = '//layouts/column1';
        $this->render('events');
        }
    ...
    public function actionblog()
        {
        $this->pageCaption = 'Blog - Green Dot';
        $this->layout = '//layouts/column1';
        $this->render('blog');
        }
...
//        {
//        $this->pageCaption = 'Contact - Green Dot';
//        $this->layout = '//layouts/column1';
//        $this->render('events');
//        }
                                            ...
                                            <table width="650px" id="body" style="width: 500px;
                                                ...
                                                <tr>
                                                    <td id="header" style="color: white;
                                                        ...
                                                        font-weight: bold;
                                                        margin-bottom: 30px;
                                                        border-radius: 4px 4px 4px 4px;">Hello &nbsp;<b> Green Dot </b></td>
                                                </tr>
                                                <tr>
