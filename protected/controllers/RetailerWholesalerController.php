...
class RetailerWholesalerController extends GxController {
	...
	{
		$model = $this->loadModel($id, 'RetailerWholesaler');
	...
	{
		$model = new RetailerWholesaler;

		$this->performAjaxValidation($model, 'retailer-wholesaler-form');

		if (isset($_POST['RetailerWholesaler'])) {
			$model->setAttributes($_POST['RetailerWholesaler']);
	...
	public function actionDelete($id) 
	{
		...
		if (Yii::app()->getRequest()->getIsPostRequest()) {
			$this->loadModel($id, 'RetailerWholesaler')->delete();
	...
	public function actionIndex() 
	{
		...
		$dataProvider = new CActiveDataProvider('RetailerWholesaler');
	...
	public function actionSearch()
	{
		...
		if (isset($_GET['RetailerWholesaler']))
		{
			$model->setAttributes($_GET['RetailerWholesaler']);
	...
	{
		$model = new RetailerWholesaler('search');
		$model->unsetAttributes();
		$this->updateMenuItems($model);
	...
	{	
		...
		if ( $model == null ) $model = new RetailerWholesaler();
