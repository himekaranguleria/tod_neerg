    ...
    <div class="login-box col-md-6 col-md-offset-3">    		
        ...
        <div class="login-inner">
              <div class="form-group">
                  ...
                  <img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/Halal-Final-Logo_trans.png" style="height:200px;width:150px" align="middle" class="center">  
            </div>
...
<div class="form-group">
            ...
            <div class="form-group center">
                <label style="color:#fff;text-align:center" class="center"> Forgot Password </label>
