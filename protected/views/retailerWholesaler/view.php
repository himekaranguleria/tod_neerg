...
array(
			'name' => 'retailer',
			'type' => 'raw',
			'value' => $model->retailer !== null ? GxHtml::link(GxHtml::encode(GxHtml::valueEx($model->retailer)), array('retailer/view', 'id' => GxActiveRecord::extractPkValue($model->retailer, true))) : null,
			),
array(
			'name' => 'wholesaler',
			'type' => 'raw',
			'value' => $model->wholesaler !== null ? GxHtml::link(GxHtml::encode(GxHtml::valueEx($model->wholesaler)), array('wholesaler/view', 'id' => GxActiveRecord::extractPkValue($model->wholesaler, true))) : null,
			),
array(
				'name' => 'state_id',
				'type' => 'raw',
