...
<div class="view">
	...
	<br />
	<?php echo GxHtml::encode($data->getAttributeLabel('retailer_id')); ?>:
		<?php echo GxHtml::encode(GxHtml::valueEx($data->retailer)); ?>
	<br />
	<?php echo GxHtml::encode($data->getAttributeLabel('wholesaler_id')); ?>:
		<?php echo GxHtml::encode(GxHtml::valueEx($data->wholesaler)); ?>
	<br />
