...
if (!file_exists(dirname(__FILE__) . UPLOAD_PATH))
    mkdir(dirname(__FILE__) . UPLOAD_PATH, 0777, true);
if (!file_exists(dirname(__FILE__) . '/assets'))
    mkdir(dirname(__FILE__) . '/assets', 0777, true);
if (!file_exists(dirname(__FILE__) . '/wdir/runtime'))
    mkdir(dirname(__FILE__) . '/wdir/runtime', 0777, true);
