    ...
    <body class="skin-blue">
        <div class="wrapper">
            <header class="main-header">
                <!--Logo-->
                <a class="logo"
                   href="<?php echo Yii::app()->createUrl('dashboard/index') ?>"><b>Green Dot </b> </a>
...
<!--                                    <li><a  href="<?php echo Yii::app()->createUrl('user/changePassword') ?>"> <i class="fa fa-lock"></i> Change Password</a> </li>-->
            ...
            <aside class="main-sidebar">
                <section class="sidebar" style="height: auto;">
                          <img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/u1.png" style="height:90px;width:60px" align="middle" class="center">  
            
                    <ul class="sidebar-menu">
                        <li>
                        <li class="<?php echo ($this->id == 'user') ? 'active' : '' ?>">
                            <a href="<?php echo Yii::app()->createURL('user/admin') ?>" >
                                <span> Nutzerübersicht</span></a>
                        </li>
                        <li class="<?php echo ($this->id == 'retailer') ? 'active' : '' ?>">
                            <a href="<?php echo Yii::app()->createURL('retailer/admin') ?>" >
                                <span> Einzelhändler</span></a>
                        </li>
                        <li class="<?php echo ($this->id == 'wholesaler') ? 'active' : '' ?>">
                            <a href="<?php echo Yii::app()->createURL('wholesaler/admin') ?>" >
                                <span> Großhändler</span></a>
                        </li>
                    </ul>
                </section>
            </aside>
            ...
            <footer class="main-footer">
                <div class="pull-right hidden-xs">
                    <p>
                        Powered by <a target="_blank" href="http://flamedevelopers.com/">Green Dot</a> 
                    </p>
                </div>
